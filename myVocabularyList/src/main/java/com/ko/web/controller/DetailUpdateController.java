...
public class DetailUpdateController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("vocabname: "+vocabName);
		System.out.println("ch_english: "+changedEnglish);
		System.out.println("ch_koran: "+changedKorean);
		System.out.println("enlgish: "+english);
